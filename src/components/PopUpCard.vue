...
#adModal .btn-close {
    z-index: 1055;
    color: white; /* Make the close button icon white */
    background-color: white; /* Ensure the button background is white */
    opacity: 1; /* Make sure the button is fully opaque */
}

.adModal .btn-close:hover {
    color: white; /* Keep the icon white on hover */
    background-color: white; /* Keep the background white on hover */
    opacity: 1; /* Ensure it remains opaque */
}
